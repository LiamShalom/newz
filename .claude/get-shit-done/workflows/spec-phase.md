...
```bash
INIT=$(node "/Users/roanhoward/Desktop/newz/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/roanhoward/Desktop/newz/.claude/get-shit-done/templates/spec.md.
