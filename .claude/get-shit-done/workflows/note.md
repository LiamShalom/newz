...
- **Global scope**: `/Users/roanhoward/Desktop/newz/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/roanhoward/Desktop/newz/.claude/notes/`)
...
2. Glob `/Users/roanhoward/Desktop/newz/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/roanhoward/Desktop/newz/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/roanhoward/Desktop/newz/.claude/notes/` — works in any directory
