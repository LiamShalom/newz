...
```
Task(
  prompt="Read /Users/roanhoward/Desktop/newz/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/roanhoward/Desktop/newz/.claude/get-shit-done/templates/VALIDATION.md`
