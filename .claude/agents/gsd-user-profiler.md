...
<reference>
@/Users/roanhoward/Desktop/newz/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/roanhoward/Desktop/newz/.claude/get-shit-done/references/user-profiling.md` to load:
