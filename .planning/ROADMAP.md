...
Plans:
- [ ] 09-01-PLAN.md — deps + config env vars (asyncpg/alembic, DATABASE_URL/METADATA_BACKEND/KEEPALIVE_INTERVAL_S/OFFLINE_DEMO)
- [ ] 09-02-PLAN.md — git mv db.py to db_sqlite.py + add explicit __all__ list (lift-and-shift, D-07)
...
- [ ] 09-06-PLAN.md — railway.toml + railway.json preDeployCommand for alembic upgrade head (D-13 corrected, DB-02)
