    ...
    >
      ...
      <div className="flex items-end gap-2">
        <textarea
          ...
          className="flex-1 resize-none rounded-2xl border border-hairline bg-surface-elevated px-3 py-2 text-[15px] leading-snug text-ink-primary placeholder:text-ink-secondary focus:outline-none focus:ring-1 focus:ring-coral"
